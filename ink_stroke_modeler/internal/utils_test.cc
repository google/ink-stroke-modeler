...
TEST(UtilsTest, GetStrokeNormal) {
  EXPECT_EQ(GetStrokeNormal({.velocity = {0, 0}, .acceleration = {0, 0}},
                            Duration(0.1), Vec2{}),
            Vec2{});
  EXPECT_THAT(GetStrokeNormal({.velocity = {0, 0}, .acceleration = {4, 3}},
                              Duration(0.1), Vec2{}),
              Vec2Eq({-3, 4}));
  EXPECT_THAT(GetStrokeNormal({.velocity = {2, 3}, .acceleration = {0, 0}},
                              Duration(0.1), Vec2{}),
              Vec2Eq({-3, 2}));
  EXPECT_THAT(GetStrokeNormal({.velocity = {0, 1}, .acceleration = {-1, 0}},
                              Duration(1), Vec2{}),
              Vec2Near({-1.7071, -0.7071}, 1e-4));
  EXPECT_THAT(GetStrokeNormal({.velocity = {1, 0}, .acceleration = {3, 4}},
                              Duration(0.1), Vec2{}),
              Vec2Near({-0.2941, 1.9558}, 1e-4));
  EXPECT_THAT(GetStrokeNormal({.velocity = {3, 0}, .acceleration = {-3, 0}},
                              Duration(0.1), Vec2{}),
              Vec2Near({0, 3}, 1e-4));
}
