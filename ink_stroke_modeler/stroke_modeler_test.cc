...
TEST(StrokeModelerTest, WobbleSmoothed) {
  ...
  results = modeler.Update({.event_type = Input::EventType::kMove,
                            ...
                            .time = time});
  ASSERT_TRUE(results.ok());
  EXPECT_THAT(*results, ElementsAre(ResultNear({.position = {-6.0059, -2.0001},
  ...
  results = modeler.Update({.event_type = Input::EventType::kMove,
                            ...
                            .time = time});
  ASSERT_TRUE(results.ok());
  EXPECT_THAT(*results, ElementsAre(ResultNear({.position = {-6.0141, -2.0030},
  ...
  results = modeler.Update({.event_type = Input::EventType::kMove,
                            ...
                            .time = time});
  ASSERT_TRUE(results.ok());
  EXPECT_THAT(*results, ElementsAre(ResultNear({.position = {-6.0209, -2.0082},
