...
TEST(StrokeModelerTest, WobbleSmoothed) {
  ...
  results = modeler.Update({.event_type = Input::EventType::kMove,
                            ...
                            .time = time});
  ASSERT_TRUE(results.ok());
  EXPECT_THAT(*results, ElementsAre(ResultNear({.position = {-6.0030, -2.0001},
                                                .velocity = {-0.2563, -0.0205},
                                                .time = Time(4.0209)},
                                               kTol),
                                    ResultNear({.position = {-6.0042, -2.0003},
                                                .velocity = {-0.2857, -0.0543},
                                                .time = Time(4.0251)},
                                               kTol),
                                    ResultNear({.position = {-6.0055, -2.0007},
                                                .velocity = {-0.3018, -0.0956},
                                                .time = Time(4.0292)},
                                               kTol),
                                    ResultNear({.position = {-6.0068, -2.0013},
                                                .velocity = {-0.3078, -0.1401},
                                                .time = Time(4.0334)},
                                               kTol)));
  ...
  results = modeler.Update({.event_type = Input::EventType::kMove,
                            ...
                            .time = time});
  ASSERT_TRUE(results.ok());
  EXPECT_THAT(*results, ElementsAre(ResultNear({.position = {-6.0082, -2.0021},
                                                .velocity = {-0.3372, -0.1845},
                                                .time = Time(4.0376)},
                                               kTol),
                                    ResultNear({.position = {-6.0097, -2.0030},
                                                .velocity = {-0.3815, -0.2266},
                                                .time = Time(4.0418)},
                                               kTol),
                                    ResultNear({.position = {-6.0116, -2.0041},
                                                .velocity = {-0.4338, -0.2649},
                                                .time = Time(4.0459)},
                                               kTol),
                                    ResultNear({.position = {-6.0136, -2.0054},
                                                .velocity = {-0.4891, -0.2986},
                                                .time = Time(4.0501)},
                                               kTol)));
  ...
  results = modeler.Update({.event_type = Input::EventType::kMove,
                            ...
                            .time = time});
  ASSERT_TRUE(results.ok());
  EXPECT_THAT(*results, ElementsAre(ResultNear({.position = {-6.0158, -2.0068},
                                                .velocity = {-0.5232, -0.3478},
                                                .time = Time(4.0543)},
                                               kTol),
                                    ResultNear({.position = {-6.0181, -2.0085},
                                                .velocity = {-0.5407, -0.4054},
                                                .time = Time(4.0585)},
                                               kTol),
                                    ResultNear({.position = {-6.0203, -2.0105},
                                                .velocity = {-0.5457, -0.4658},
                                                .time = Time(4.0626)},
                                               kTol),
                                    ResultNear({.position = {-6.0226, -2.0126},
                                                .velocity = {-0.5416, -0.5251},
                                                .time = Time(4.0668)},
                                               kTol)));
}
