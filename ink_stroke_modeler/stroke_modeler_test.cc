...
TEST(StrokeModelerTest, InputRateSlowerThanMinOutputRate) {
  ...
  ASSERT_TRUE(modeler
                  ...
                  .ok());
  EXPECT_THAT(results,
              ElementsAre(ResultNear({.position = {3, 4}, .time = Time(0)},
                                     kTol, kAccelTol)));
...
TEST(StrokeModelerTest, InputRateSlowerThanMinOutputRateNormalProjection) {
  const Duration kDeltaTime{1. / 30};
...
TEST(StrokeModelerTest,
     InputRateSlowerThanMinOutputRateNormalProjectionWithLoopMitigation) {
  const Duration kDeltaTime{1. / 30};
  StrokeModelParams params = kDefaultParams;
  params.stylus_state_modeler_params.use_stroke_normal_projection = true;
  ...
  EXPECT_THAT(results,
              ElementsAre(ResultNear({.position = {3.0019, 4.0019},
                                     ...
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.0069, 4.0069},
                                      .velocity = {0.9909, 0.9909},
                                      .acceleration = {126.6022, 126.6014},
                                      .time = Time(0.00952381)},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.0154, 4.0154},
                                      .velocity = {1.6577, 1.6577},
                                      .acceleration = {143.4044, 143.4039},
                                      .time = Time(0.0142857)},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.0276, 4.0276},
                                      .velocity = {2.3131, 2.3131},
                                      .acceleration = {142.7971, 142.7955},
                                      .time = Time(0.0190476)},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.0433, 4.0433},
                                      .velocity = {2.9214, 2.9214},
                                      .acceleration = {133.0543, 133.0539},
                                      .time = Time(0.0238095)},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.0622, 4.0622},
                                      .velocity = {3.4742, 3.4742},
                                      .acceleration = {120.1235, 120.1227},
                                      .time = Time(0.0285714)},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.0838, 4.0838},
                                      .velocity = {3.9782, 3.9782},
                                      .acceleration = {107.9054, 107.9059},
                                      .time = Time(0.0333333)},
                                     kTol, kAccelTol)));

  ASSERT_TRUE(modeler.Predict(results).ok());
  EXPECT_THAT(results,
              ElementsAre(ResultNear({.position = {3.10949, 4.10949},
                                      .velocity = {4.19914, 4.19913},
                                      .acceleration = {41.8473, 41.8476},
                                      .time = Time(0.0388889)},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.13314, 4.13314},
                                      .velocity = {4.16388, 4.16387},
                                      .acceleration = {-0.79512, -0.795006},
                                      .time = Time(0.0444444)},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.1534, 4.1534},
                                      .velocity = {4.00923, 4.00922},
                                      .acceleration = {-15.7575, -15.7574},
                                      .time = Time(0.05)},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.1698, 4.1698},
                                      .velocity = {3.80299, 3.80299},
                                      .acceleration = {-14.803, -14.803},
                                      .time = Time(0.0555556)},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.18238, 4.18238},
                                      .velocity = {3.58047, 3.58046},
                                      .acceleration = {-5.50763, -5.50725},
                                      .time = Time(0.0611111)},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.19153, 4.19153},
                                      .velocity = {3.36166, 3.36166},
                                      .acceleration = {7.42517, 7.42575},
                                      .time = Time(0.0666667)},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.19779, 4.19779},
                                      .velocity = {3.15865, 3.15865},
                                      .acceleration = {21.1664, 21.1667},
                                      .time = Time(0.0722222)},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.19921, 4.19921},
                                      .velocity = {3.12532, 3.12532},
                                      .acceleration = {33.1267, 33.1264},
                                      .time = Time(0.0736111)},
                                     kTol, kAccelTol)));
  ...
  ASSERT_TRUE(modeler
                  ...
                  .ok());
  EXPECT_THAT(results,
              ElementsAre(ResultNear({.position = {3.10806, 4.10611},
                                      .velocity = {4.57574, 4.16572},
                                      .acceleration = {127.197, 41.096},
                                      .time = Time(0.0380952),
                                      .pressure = -1,
                                      .tilt = -1,
                                      .orientation = -1},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.13529, 4.12867},
                                      .velocity = {5.22357, 4.22006},
                                      .acceleration = {136.649, 7.26822},
                                      .time = Time(0.0428571),
                                      .pressure = -1,
                                      .tilt = -1,
                                      .orientation = -1},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.16495, 4.1509},
                                      .velocity = {5.88198, 4.24741},
                                      .acceleration = {141.224, -2.77902},
                                      .time = Time(0.047619),
                                      .pressure = -1,
                                      .tilt = -1,
                                      .orientation = -1},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.19714, 4.17332},
                                      .velocity = {6.55079, 4.3372},
                                      .acceleration = {144.959, 4.50102},
                                      .time = Time(0.052381),
                                      .pressure = -1,
                                      .tilt = -1,
                                      .orientation = -1},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.23516, 4.18583},
                                      .velocity = {7.05712, 3.94619},
                                      .acceleration = {136.785, -2.18567},
                                      .time = Time(0.0571429),
                                      .pressure = -1,
                                      .tilt = -1,
                                      .orientation = -1},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.27574, 4.19189},
                                      .velocity = {7.44526, 3.31069},
                                      .acceleration = {122.731, -17.3051},
                                      .time = Time(0.0619048),
                                      .pressure = -1,
                                      .tilt = -1,
                                      .orientation = -1},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.31707, 4.19611},
                                      .velocity = {7.79387, 2.68079},
                                      .acceleration = {109.01, -32.7855},
                                      .time = Time(0.0666667),
                                      .pressure = -1,
                                      .tilt = -1,
                                      .orientation = -1},
  ...
  ASSERT_TRUE(modeler.Predict(results).ok());
  EXPECT_THAT(results,
              ElementsAre(ResultNear({.position = {3.36247, 4.19918},
                                      .velocity = {7.82506, 1.9889},
                                      .acceleration = {36.6378, -52.214},
                                      .time = Time(0.0722222),
                                      .pressure = -1,
                                      .tilt = -1,
                                      .orientation = -1},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.40182, 4.20095},
                                      .velocity = {7.59943, 1.39706},
                                      .acceleration = {-12.3566, -68.0143},
                                      .time = Time(0.0777778),
                                      .pressure = -1,
                                      .tilt = -1,
                                      .orientation = -1},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.43436, 4.20185},
                                      .velocity = {7.26393, 0.909868},
                                      .acceleration = {-33.7773, -81.8364},
                                      .time = Time(0.0833333),
                                      .pressure = -1,
                                      .tilt = -1,
                                      .orientation = -1},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.45985, 4.20219},
                                      .velocity = {6.89675, 0.530651},
                                      .acceleration = {-38.1341, -92.9533},
                                      .time = Time(0.0888889),
                                      .pressure = -1,
                                      .tilt = -1,
                                      .orientation = -1},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.47879, 4.20218},
                                      .velocity = {6.54056, 0.252091},
                                      .acceleration = {-32.5213, -101.155},
                                      .time = Time(0.0944444),
                                      .pressure = -1,
                                      .tilt = -1,
                                      .orientation = -1},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.49209, 4.20198},
                                      .velocity = {6.21791, 0.0604567},
                                      .acceleration = {-21.6624, -106.639},
                                      .time = Time(0.1),
                                      .pressure = -1,
                                      .tilt = -1,
                                      .orientation = -1},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.49758, 4.20186},
                                      .velocity = {6.09132, -0.0134538},
                                      .acceleration = {-8.09663, -107.585},
                                      .time = Time(0.102778),
                                      .pressure = -1,
                                      .tilt = -1,
                                      .orientation = -1},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.50003, 4.20179},
                                      .velocity = {6.03536, -0.0451609},
                                      .acceleration = {-2.68494, -108.424},
                                      .time = Time(0.104167),
                                      .pressure = -1,
                                      .tilt = -1,
                                      .orientation = -1},
  ...
  ASSERT_TRUE(modeler
                  ...
                  .ok());
  EXPECT_THAT(results,
              ElementsAre(ResultNear({.position = {3.35822, 4.19982},
                                      .velocity = {8.01552, 2.25652},
                                      .acceleration = {76.5494, -10.244},
                                      .time = Time(0.0714286),
                                      .pressure = -1,
                                      .tilt = -1,
                                      .orientation = -1},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.39818, 4.20377},
                                      .velocity = {8.16092, 1.95473},
                                      .acceleration = {54.6779, -7.5807},
                                      .time = Time(0.0761905),
                                      .pressure = -1,
                                      .tilt = -1,
                                      .orientation = -1},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.43694, 4.20831},
                                      .velocity = {8.27085, 1.70691},
                                      .acceleration = {40.3218, -19.3075},
                                      .time = Time(0.0809524),
                                      .pressure = -1,
                                      .tilt = -1,
                                      .orientation = -1},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.47425, 4.21358},
                                      .velocity = {8.36884, 1.47493},
                                      .acceleration = {31.1822, -40.7319},
                                      .time = Time(0.0857143),
                                      .pressure = -1,
                                      .tilt = -1,
                                      .orientation = -1},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.52183, 4.23739},
                                      .velocity = {8.14158, 1.89134},
                                      .acceleration = {11.2695, -28.9675},
                                      .time = Time(0.0904762),
                                      .pressure = -1,
                                      .tilt = -1,
                                      .orientation = -1},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.55161, 4.26074},
                                      .velocity = {7.78899, 2.56033},
                                      .acceleration = {-1.06749, -4.33054},
                                      .time = Time(0.0952381),
                                      .pressure = -1,
                                      .tilt = -1,
                                      .orientation = -1},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.58032, 4.2848},
                                      .velocity = {7.4481, 3.20974},
                                      .acceleration = {-12.4765, 18.9295},
                                      .time = Time(0.1),
                                      .pressure = -1,
                                      .tilt = -1,
                                      .orientation = -1},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.61231, 4.31328},
                                      .velocity = {6.88677, 3.78659},
                                      .acceleration = {-57.2744, 16.7512},
                                      .time = Time(0.105556),
                                      .pressure = -1,
                                      .tilt = -1,
                                      .orientation = -1},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.63903, 4.33789},
                                      .velocity = {6.28349, 4.13275},
                                      .acceleration = {-87.8078, 19.2502},
                                      .time = Time(0.111111),
                                      .pressure = -1,
                                      .tilt = -1,
                                      .orientation = -1},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.66058, 4.35832},
                                      .velocity = {5.70726, 4.325},
                                      .acceleration = {-103.226, 30.4577},
                                      .time = Time(0.116667),
                                      .pressure = -1,
                                      .tilt = -1,
                                      .orientation = -1},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.67709, 4.37437},
                                      .velocity = {5.19932, 4.40631},
                                      .acceleration = {-108.466, 45.3322},
                                      .time = Time(0.122222),
                                      .pressure = -1,
                                      .tilt = -1,
                                      .orientation = -1},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.68908, 4.38634},
                                      .velocity = {4.77641, 4.41053},
                                      .acceleration = {-107.196, 60.7323},
                                      .time = Time(0.127778),
                                      .pressure = -1,
                                      .tilt = -1,
                                      .orientation = -1},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.69727, 4.39475},
                                      .velocity = {4.44027, 4.36461},
                                      .acceleration = {-102.095, 74.8818},
                                      .time = Time(0.133333),
                                      .pressure = -1,
                                      .tilt = -1,
                                      .orientation = -1},
                                     kTol, kAccelTol),
                          ResultNear({.position = {3.70061, 4.39824},
                                      .velocity = {4.3027, 4.33934},
                                      .acceleration = {-93.9521, 84.6634},
                                      .time = Time(0.136111),
                                      .pressure = -1,
                                      .tilt = -1,
                                      .orientation = -1},
...
TEST(StrokeModelerTest, InputRateFasterThanMinOutputRate) {
  ...
  ASSERT_TRUE(modeler
                  ...
                  .ok());
  EXPECT_THAT(results,
              ElementsAre(ResultNear({.position = {5, -3}, .time = Time(2)},
                                     kTol, kAccelTol)));
...
TEST(StrokeModelerTest, WobbleSmoothed) {
  ...
  ASSERT_TRUE(modeler
                  ...
                  .ok());
  EXPECT_THAT(results,
              ElementsAre(ResultNear({.position = {-6, -2}, .time = Time(4)},
                                     kTol, kAccelTol)));
...
TEST(StrokeModelerTest, UpdateAppendsToResults) {
  ...
  auto first_result_matcher =
      ResultNear({.position = {5, -3}, .time = Time(2)}, kTol, kAccelTol);
...
TEST(StrokeModelerTest, GenerateOutputOnTUpEvenIfNoTimeDelta) {
  ...
  ASSERT_TRUE(modeler
                  ...
                  .ok());
  EXPECT_THAT(results,
              ElementsAre(ResultNear({.position = {5, 5}, .time = Time(0)},
                                     kTol, kAccelTol)));
  ...
  ASSERT_TRUE(modeler
                  ...
                  .ok());
  EXPECT_THAT(results,
              ElementsAre(ResultNear({.position = {5, 5}, .time = Time(0.002)},
                                     kTol, kAccelTol)));
  ...
  ASSERT_TRUE(modeler
                  ...
                  .ok());
  EXPECT_THAT(results,
              ElementsAre(ResultNear({.position = {5, 5}, .time = Time(0.0076)},
                                     kTol, kAccelTol)));
}
...
TEST(StrokeModelerTest, UpdateUpdateIdenticalToUpdatePredictUpdate) {
  Input input1 = {.event_type = Input::EventType::kDown,
                  .position = {-6, -2},
                  .time = Time(0),
                  .pressure = 0.5,
                  .tilt = 0.5,
  ...
  Input input2 = {.event_type = Input::EventType::kMove,
                  .position = {-6.2, -2},
                  .time = Time(.0167),
                  .pressure = 0.48,
                  .tilt = 0.4,
                  .orientation = 0.4};
  Input input3 = {.event_type = Input::EventType::kMove,
                  .position = {-6.2, -2.2},
                  .time = Time(0.0334),
                  .pressure = 0.48,
                  .tilt = 0.4,
  ...
  std::vector<Result> results_with_predict;
  std::vector<Result> results_without_predict;

  // Run the first 2 input updates, then a prediction then the last input.
  ASSERT_TRUE(modeler.Update(input1, results_with_predict).ok());
  results_with_predict.clear();
  ASSERT_TRUE(modeler.Update(input2, results_with_predict).ok());
  results_with_predict.clear();
  ASSERT_TRUE(modeler.Predict(results_with_predict).ok());
  results_with_predict.clear();
  ASSERT_TRUE(modeler.Update(input3, results_with_predict).ok());

  // Reset the modeler and run the same 3 input updates again but without
  // prediction.
  ASSERT_TRUE(modeler.Reset(kDefaultParams).ok());
  ASSERT_TRUE(modeler.Update(input1, results_without_predict).ok());
  results_without_predict.clear();
  ASSERT_TRUE(modeler.Update(input2, results_without_predict).ok());
  results_without_predict.clear();
  ASSERT_TRUE(modeler.Update(input3, results_without_predict).ok());

  // The results for both runs should be the same.
  EXPECT_EQ(results_with_predict, results_without_predict);
}
